...
There are 16 points total available from three different tasks. See extra_credit.md for the Extra Credit Handout.

1. Socially Responsible Computing (src): Character Sets (4 points) [charsets.md]
2. Unicode and Reflection Questions (4 points) [unicode.md]
3. Improve Snake (up to 8 points) [snake.md]
